...
this.wordle.bundle = function(e) {
    ...
    var G, F = I["__core-js_shared__"], W = (G = /[^.]+$/.exec(F && F.keys && F.keys.IE_PROTO || "")) ? "Symbol(src)_1." + G : "";
        ...
        if (d)
            ...
            if (p) {
                var m = Me(l)
                  ...
                  , y = !m && !h && Ke(l);
                u = l,
                m || h || y ? Me(i) ? u = i : _e(c = i) && Re(c) ? u = function(e, a) {
                    var s = -1
                      , t = e.length;
                    for (a || (a = Array(t)); ++s < t; )
                        a[s] = e[s];
                ...
                Ie(i) ? u = da(i) : V(i) && !B(i) || (u = function(e) {
    ...
    var Va = new Date(2021,5,19,0,0,0,0);
    function Ba(e, a) {
        var s = new Date(e)
        ...
        return o(t, [{
                    ...
                    if (this.hardMode) {
                        var t = function(e, a, s) {
                            ...
                            for (var o = {}, n = 0; n < s.length; n++)
                                [Ha, Ra].includes(s[n]) && (o[a[n]] ? o[a[n]] += 1 : o[a[n]] = 1);
            ...
            value: function() {
                ...
                this.shadowRoot.addEventListener("game-setting-change", (function(e) {
                    ...
                    switch (s) {
                    case "hard-mode":
                        return void (o ? d.addToast("Hard mode can only be enabled at the start of a round", 1500, !0) : (d.hardMode = t,
                        ja({
                            hardMode: t
                        })))
                    }
                ...
                function(e, a, s, t, o, n) {
                    ...
                    var r = a.getElementsByTagName(s)[0]
                      , i = a.createElement(s);
                    i.async = !0,
                    i.src = "https://www.googletagmanager.com/gtm.js?id=" + o + n + "&gtm_cookies_win=x",
                ...
                n = encodeURIComponent((s = document.querySelector("link[rel=canonical]")) ? s.href : document.location.href),
                (r = new XMLHttpRequest).withCredentials = !0,
                r.open("GET", "https://" + t + "/svc/nyt/data-layer?sourceApp=" + e.application.name + "&referrer=" + o + "&assetUrl=" + n, !0),
                r.onload = function() {
